        ...
        <table width="700" align="center">
				...
				foreach($oneNgo->result() as $row){
					...
					$inputs=array(
								  ...
								  form_input("txt_ngosdate",$this->input->post("txt_ngosdate")?$this->input->post("txt_ngosdate"):$row->ngo_sdate,"class='datePicker'"),
								  form_input("txt_ngoedate",$this->input->post("txt_ngoedate")?$this->input->post("txt_ngoedate"):$row->ngo_edate,"class='datePicker'"),
								  form_textarea($text)
								  );
					$validate=array(
