<div class="task1">
	<?php 
	foreach($getOneTer->result() as $row){
	?>
	<fieldset>
    <legend align="center"><div class="heading">Edit <?php echo $row->ter_name;?></div></legend>
    ...
    <div class="addnew"><br />
    <?php echo form_open("generation/editTerm");?>
        <table width="700" align="center" id="myTable">
                ...
                <?php
					...
					$inputs=array(
								  ...
								  form_input("txt_tersdate",$this->input->post("txt_tersdate")?$this->input->post("txt_tersdate"):$row->ter_start_date,"id='startPicker'")." <span style='color:#000;'>ex: yyyy-mm-date</span>",
								  form_input("txt_teredate",$this->input->post("txt_teredate")?$this->input->post("txt_teredate"):$row->ter_end_date,"id='endPicker'")." <span style='color:#000;'>ex: yyyy-mm-date</span>",
								  );
					$validate=array(
